...
function updateSessionUi() {
  ...
  byId("recordTitle").textContent =
    `${roleShortName(state.role)} bereit machen`;

  byId("openCameraButton").textContent =
    `${roleShortName(state.role)} ÖFFNEN`;

  byId("cameraDialogTitle").textContent =
    roleShortName(state.role);

  byId("cameraRoleLabel").textContent =
    roleName(state.role);
}
...
function renderSetup() {
  const positions = {
    A: {
      ...
      text:
        "Stelle dieses Handy seitlich an der Laufstrecke auf. Der ganze Hund muss im Bild sein.",
      letter: "A",
      direction: "SEITLICH",
      left: "48%",
      right: "auto",
    ...
    B: {
      ...
      text:
        "Stelle dieses Handy vorne links an der Strecke auf. Der Hund läuft gerade auf die Kamera zu.",
      letter: "B",
    ...
    C: {
      ...
      text:
        "Stelle dieses Handy hinter der Strecke auf. Der Hund läuft gerade von der Kamera weg.",
      letter: "C",
